...
--
-- Client :  127.0.0.1
-- Généré le :  Jeu 01 Décembre 2016 à 14:17
...
(4, 2, '0000-00-00', 1, NULL, 0, 4),
(5, 1, '0000-00-00', 1, NULL, 0, 4),
(7, 1, '0000-00-00', 1, NULL, 0, 4);
...
(1, 'toto', '$2a$08$QZw5jt/wAhQCj8MapvDx7.ggCNTHifI0fhZJm/fX5NFbBOZNvBrTG', 'toto@toto.toto', 1, 0, NULL, NULL, NULL, NULL, NULL, '::1', '2016-12-01 13:59:58', '2016-11-29 17:54:13', '2016-12-01 12:59:58', 300),
...
--
ALTER TABLE `intreventions`
  MODIFY `id_intrevention` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
...
--
ALTER TABLE `origines`
  MODIFY `id_origine` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `thematics`
  MODIFY `id_thematic` int(11) NOT NULL AUTO_INCREMENT;
--
